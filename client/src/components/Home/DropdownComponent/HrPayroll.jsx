...
import HrPayrollImage from "../../Photos/eeeeeeeeeee.jpg"
...
function HrPayroll() {
  ...
  return (<>
    ...
    <div className='mainDetailContainer'>
      ...
      <div className='mainDetailContainerHeading'>HR Payroll Management</div>
      ...
      <div className='mainDetailContainerImage'><img src={HrPayrollImage} alt="image" /></div>
